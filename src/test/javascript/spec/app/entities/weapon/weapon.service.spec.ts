    ...
    describe('Weapon Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/weapons';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Weapon', () => {
                service.create(new Weapon(null)).subscribe(received => {
            ...
            it('should update a Weapon', () => {
                service.update(new Weapon(123)).subscribe(received => {
